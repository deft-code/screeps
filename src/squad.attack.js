class AttackSquad {
  execute() {
    ...
    return this.upkeepRole('archer', 1) || this.upkeepRole('caboose', 1);
...
Creep.prototype.roleCaboose = function() {
  return this.actionTask() || this.actionCabooseFind() ||
      this.actionSelfHeal() || this.idleMoveNear(this.squad.flag);
};
...
Creep.prototype.actionArcher = function(room) {
  ...
  // c => c.getActiveBodyparts(CLAIM) || c.getActiveBodyparts(CARRY) >
