...
class MinerSquad extends modsquads.Squad {
    ...
    execute() {
        ...
        if(nminers > 0 && room.energyAvailable < 600 && room.energyAvailable < room.energyCapacityAvailable) {
            return "need energy";
        }
    ...
    roleMiner() {
        ...
        const who = this.spawn.createRole(body, 3, {role: "miner", squad: this.name});
        if(_.isString(who)) {
