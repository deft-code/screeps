import { CreepMove } from "t.creep.move";
...
// Supplied by role.chemist.js, merged onto the wrapper prototype (was: declare global Creep.taskSortMineral).
export interface CreepCarry {
